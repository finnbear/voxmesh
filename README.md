...
- Block shapes
  ...
  - Fluids with a shared surface height field (e.g. flowing water)
  - Fluid-logged blocks
...
Most of the code was AI generated by Claude Code, albeit with significant guidance.

## License

Textures (`examples/*.png`) may not be redistributed (except as-is in forks) or used commercially.
